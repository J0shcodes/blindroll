...
export function useContract(): UseContractReturn {
  ...
  const isEmployer =
    !!walletAddress &&
    !!employerAddress &&
    (walletAddress as string).toLowerCase() === (employerAddress as string).toLowerCase();

  const isEmployee = isActiveEmployee === true
  ...
  const { mutate, mutateAsync, reset, isPending, error: writeError, data: txHash } = useWriteContract();
